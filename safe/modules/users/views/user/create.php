...
<table class="tablesearch">
    <tbody>
        ...
        <tr>
            ...
            <td> <?php echo Form::activeTextField($model, 'nickname', array("size" => "30", 'class' => 'input-text', 'size' => 30)); ?></td>
...
<table class="tablesearch" style="margin-top: 20px">
    <tbody><tr>
            ...
            <td>
                ...
                <?php echo Form::activePasswordField($model, 'password', array("size" => "10", 'class' => 'input-text')); ?>
            ...
            <td valign="top">
                <?php echo Form::activePasswordField($model, 'repeatpass', array("size" => "10", 'class' => 'input-text')); ?>
                <?php echo Form::activeHiddenField($model, 'profile_id'); ?>  
            </td>
    ...
    <tbody>
        <tr>
            <td width="100%" valign="top" scope="row">
                ...
                <?php echo Form::activeDropDownList($model, 'profile_id', $profilesData, array("prompt" => '-- Seleccione Perfil --', 'class' => 'input-text', 'onchange' => 'loadPermissions(this.value)')); ?>
